...
box.d <- boxr::box_dir_create(dir_name = box_dir, parent_dir_id = "XXXXXXXXX")

# upload local dir to box in new dir
boxr::box_push(dir_id = box.d[2], local_dir = getwd(),ignore_dots = TRUE,overwrite = FALSE,delete = FALSE)
